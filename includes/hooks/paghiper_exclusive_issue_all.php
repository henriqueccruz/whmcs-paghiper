...
add_hook('AdminAreaPage', 1, function($vars) {
    if ($vars['filename'] == 'configgateways' && isset($_POST['action']) && $_POST['action'] == 'save') {
        ...
        if ($module == 'paghiper' && isset($_POST['field']['issue_all']) && ($_POST['field']['issue_all'] == '1' || $_POST['field']['issue_all'] == 'on')) {
        ...
        elseif ($module == 'paghiper_pix' && isset($_POST['field']['issue_all']) && ($_POST['field']['issue_all'] == '1' || $_POST['field']['issue_all'] == 'on')) {
